...
Это означает, что есть web/мобильное приложение, в котором можно зарегистрироваться, добавлять свои устролйства, управлять ими и отслеживать состояние.
...
Реализованы два микросервиса - `telemetry` для получения телеметрии из Kafka, сохранения ее в БД и чтение оттуда, и `commands` для работы с командами для устройств. Микросервисы написаны на Go с использованием подхода 12 факторного приложения.
